...
export const Footer = () => {
  ...
  XploreLocale is place where you can upload your local attractions for other's to see.If you like this project you may reach out to me,follow me,DM me and if you have any suggesstion please do let me know.
  </p>
...
const GradientText = styled.p`
     ...
     background: #fe5a59;
     background-image: linear-gradient(-45deg,#fe5a59,#ee7752, #e73c7e, #23a6d5, #23d5ab);
